...
class Grid(
    ...
    fun eachColumnContainsEachPossibleValue(): Boolean = gridSize.height == gridSize.largestSide()

    fun eachRowContainsEachPossibleValue(): Boolean = gridSize.width == gridSize.largestSide()
}
