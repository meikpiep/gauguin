...
class MainActivityScreenshotTest(
    ...
    enum class UiStateEnum(
        ...
        NewGame(MyUiState()),
        NewGameWithCellDetails(MyUiState()),
        GameWith6x6GridFromZeroOnPossibleIn3x3(MyUiState()),
        GameWith7x7GridFromZeroOnPossibleIn3x3(MyUiState()),
        NewGameWithRectangularGrid(MyUiState()),
        NewGameWithRectangularGridAndFastFinishingMode(MyUiState()),
    }
        ...
        fun testItemProvider(): Array<out TestDataForActivity<out Enum<*>>> =
            TestDataForActivityCombinator(uiStates = UiStateEnum.entries.toTypedArray())
                .forDevices(
                    ...
                    ActivityConfigItem(uiMode = UiMode.DAY, fontSize = FontSize.SMALL),
                    ActivityConfigItem(uiMode = UiMode.NIGHT, fontSize = FontSize.LARGEST),
                ).combineAll()
    }
