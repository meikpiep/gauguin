        ...
        test("no nishio gets found") {
            val grid =
                GridBuilder(5, 5)
                    ...
                    .addCageAdd(12, GridCageType.L_VERTICAL_SHORT_LEFT_TOP)
                    .addCageAdd(7, GridCageType.ANGLE_LEFT_BOTTOM)
                    .addCageAdd(12, GridCageType.SQUARE)
                    .addCageAdd(13, GridCageType.L_HORIZONTAL_SHORT_LEFT_TOP)
                    .addCageAdd(6, GridCageType.TRIPLE_HORIZONTAL)
                    .addCageMultiply(20, GridCageType.DOUBLE_HORIZONTAL)
                    .createGrid()

            grid.cells[0].possibles = setOf(4, 5)
            grid.cells[1].possibles = setOf(1, 2, 3, 4, 5)
            grid.cells[2].possibles = setOf(1, 2, 3)
            grid.cells[3].possibles = setOf(2, 3, 4, 5)
            grid.cells[4].possibles = setOf(1, 2, 3, 4, 5)
            grid.cells[5].possibles = setOf(4, 5)
            grid.cells[6].possibles = setOf(1, 2, 3, 4)
            grid.cells[7].possibles = setOf(2, 3, 4)
            grid.cells[8].possibles = setOf(1, 2, 3)
            grid.cells[9].possibles = setOf(1, 2, 3, 4, 5)
            grid.cells[10].possibles = setOf(1, 2, 3)
            grid.cells[11].possibles = setOf(2, 3, 4, 5)
            grid.cells[12].possibles = setOf(2, 3, 4, 5)
            grid.cells[13].possibles = setOf(1, 2, 3, 4)
            grid.cells[14].possibles = setOf(1, 2, 3, 4)
            grid.cells[15].possibles = setOf(1, 2, 3)
            grid.cells[16].possibles = setOf(2, 3, 4, 5)
            grid.cells[17].possibles = setOf(2, 3, 4, 5)
            grid.cells[18].possibles = setOf(1, 2, 3, 4, 5)
            grid.cells[19].possibles = setOf(1, 2, 3)
            grid.cells[20].possibles = setOf(1, 2, 3)
            grid.cells[21].possibles = setOf(1, 2, 3)
            grid.cells[22].possibles = setOf(1, 2, 3)
            grid.cells[23].possibles = setOf(4, 5)
            grid.cells[24].possibles = setOf(4, 5)
