package org.piepmeyer.gauguin.difficulty.human2.strategy.nishio

import io.kotest.core.spec.style.FunSpec
import io.kotest.matchers.shouldBe
import org.piepmeyer.gauguin.creation.GridBuilder
import org.piepmeyer.gauguin.creation.cage.GridCageType
import org.piepmeyer.gauguin.difficulty.human2.HumanSolverCacheImpl
...
class AdvancedNishioWithPairsTest :
    FunSpec({
        ...
        test("NishioCore finds contradiction") {
            ...
            val solver = NishioCore(grid, PossiblesCacheByCageNumber(grid, cache), grid.cells[11], 6)
